...
//        CategoryName= getIntent().getExtras().get("category").toString();
        ...
        ProductImagesRef = FirebaseStorage.getInstance().getReference().child("Antibiotics Images");
        ProductsRef = FirebaseDatabase.getInstance().getReference().child("Antibiotics");
