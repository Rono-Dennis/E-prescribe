    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int permissionCheck = ContextCompat.checkSelfPermission(SmsActivity.this, Manifest.permission.SEND_SMS);
...
//                startActivity(intent);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(SmsActivity.this, UserPage.class);
