...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
    ...
    public void onLocationChanged(Location location) {
        ...
        BitmapDescriptor icon = BitmapDescriptorFactory.fromResource(R.drawable.location);        //BitmapDescriptor icon = new BitmapDescriptorFactory.fromResource(R.drawable.map);
        ...
        markerOptions.title("Order from");
    ...
    private void getNearByPharmacy()
    {
        ...
        stringBuilder.append("&type=chemist");
