...
public class ViewDrug extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(ViewDrug.this, AdminCategoryActivity.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<com.example.prescribe.Model.Payment> options = new FirebaseRecyclerOptions.Builder<com.example.prescribe.Model.Payment>()
                .setQuery(payHistory.orderByChild("dateTime").startAt(inputSearch.getText().toString()).endAt(inputSearch.getText().toString()+"\uf8ff"), com.example.prescribe.Model.Payment.class).build();
