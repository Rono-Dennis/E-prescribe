...
public class DetailActivity extends AppCompatActivity {
    ...
    private String name,qty,price,image,poster,postId,category;
    private TextView tvDetailTitle,tvDetailQty,tvDetailCategory,tvDetailPoster,tvDetailPrice,tvPosterPhone,tvPosterCounty,tvPosterSubcounty,tvPosterScaleType;
        ...
        myUsersDatabase.child(poster).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists())
                {
                    ...
                    tvDetailPoster.setText("Product Bought  By: "+name);
