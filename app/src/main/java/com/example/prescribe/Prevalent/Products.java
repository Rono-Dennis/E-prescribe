package com.example.prescribe.Prevalent;
...
public class Products {
    ...
    public Products(String post_id, String product_name, String product_category, String product_quantity, String product_price,  String post_image) {
